...
Revision ID: ecc39083cf02
Revises: 
Create Date: 2026-07-08 01:55:21.205670
...
def upgrade():
    ...
    sa.CheckConstraint('0 <= invested_amount <= full_amount', name='check_invested_amount_in_range'),
